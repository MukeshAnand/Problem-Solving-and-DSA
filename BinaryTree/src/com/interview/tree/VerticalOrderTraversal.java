...
class VerticalNode { 
	...
	VerticalNode newNode(int key) 
	{ 
		VerticalNode node = new VerticalNode(); 
		node.key = key; 
...
public class VerticalOrderTraversal { 
	...
	static void printVerticalOrder(VerticalNode root) 
	{ 
		// Base case 
		if (root == null) 
			return; 
		...
		System.out.println(VerticalOrderTraversal.class.getSimpleName());
	...
	{ 
		VerticalNode n = new VerticalNode(); 
		VerticalNode root; 
		root = n.newNode(1); 
